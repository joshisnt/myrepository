...
if __name__ == "__main__":
    ...
    while not done and charIndex < solutionLength:
        ...
        if direction == NORTH:
            ...
            print("You have no idea what your'e doing") # Invalid direction.
